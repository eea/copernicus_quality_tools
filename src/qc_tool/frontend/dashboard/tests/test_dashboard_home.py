"""Truthful, access-scoped contracts for the workspace dashboard."""
...
class DashboardHomeContractTests(TestCase):
    ...
    @patch("qc_tool.frontend.dashboard.views.available_product_descriptions")
    ...
    @patch("qc_tool.frontend.dashboard.views.get_announcement_message")
    @patch("qc_tool.frontend.dashboard.views.available_product_descriptions")
    ...
    def test_page_has_accessible_landmarks_and_truthful_empty_states(self, catalog):
        ...
        stylesheet = "dashboard/css/pages/dashboard.css"
    ...
    def test_coverage_is_disjoint_when_submitted_qc_is_still_running(self):
        ...
        dashboard = build_workspace_dashboard(access_for(self.user))
