...
class Test_clc(ProductTestCase):
    def test(self):
        ...
        expected_step_results[24] = "skipped"

        job_result = dispatch(self.job_uuid, "user_name", filepath, "clc2012", [25])
...
class Test_n2k(ProductTestCase):
    def test(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "n2k", (16,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.assertListEqual(expected_step_results, step_results)
...
class Test_rpz(ProductTestCase):
    def test(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "rpz", (16,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.assertListEqual(expected_step_results, step_results)
...
class Test_swf_vec_ras(ProductTestCase):
    def test(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "swf_2015_vec_ras", (30,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.assertListEqual(expected_step_results, step_results)
...
class Test_ua2012(ProductTestCase):
    def test_gdb(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "ua2012", (16,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.maxDiff = None
        self.assertListEqual(expected_step_results, step_results)
...
class Test_ua2018(ProductTestCase):
    def test_gdb(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "ua2018", (16,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.maxDiff = None
        self.assertListEqual(expected_step_results, step_results)
...
class Test_ua_change_2012_2018(ProductTestCase):
    def test_gdb(self):
        ...
        job_result = dispatch(self.job_uuid, "user_name", filepath, "ua_change_2012_2018", (16,))
        step_results = [step_result["status"] for step_result in job_result["steps"]]
        self.maxDiff = None
        self.assertListEqual(expected_step_results, step_results)
