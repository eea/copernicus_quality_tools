...
def run_check(params, status):
    ...
    for layer_info in params["layer_aliases"].values():
        layer_name = layer_info["src_layer_name"]
        pc = run(["ogr2ogr",
                   "-overwrite",
                   "-f", "PostgreSQL",
        ...
        if pc.returncode == 0:
            ...
            src_datasource = ogr.Open(str(layer_info["src_filepath"]), OF_READONLY)
            ...
            if dst_layer is None:
                ...
                ## Set pg info back to layer_aliases.
                ##
