...
- Go to https://github.com/eea/copernicus_quality_tools/issues and click _New Issue_.
...
See the dedicated [local development and debugging guide](docs/development/README.md).
